...
function concluir(){
    ...
    if (pix != "" && dinheiro != "" && cartao != ""){
        ...
        function opcoesMoussie(){
            ...
            var moussie_escolhido = ""
            var de = ""

            opcoesMoussie.forEach(opcaoMoussie => {
                if (opcaoMoussie.checked){
                    moussie_escolhido = opcaoMoussie.value
                    de = "de"+" "
                }
            })
            return de + moussie_escolhido
        }
        ...
        function opcoesSorvete(){
            ...
            var sorvete_escolhido = ""
            var de = ""

            opcoesSorvete.forEach(opcaoSorvete => {
                if (opcaoSorvete.checked){
                    sorvete_escolhido = opcaoSorvete.value
                    de = "de"+" "
                }
            })
            return de + sorvete_escolhido
        }
        ...
        function opcoesEmpadao(){
            ...
            var empadao_escolhido = ""
            var de = ""

            opcoesEmpadao.forEach(opcaoEmpadao => {
                if (opcaoEmpadao.checked){
                    empadao_escolhido = opcaoEmpadao.value
                    de = "de"+" "
                }
            })
            return de + empadao_escolhido
        }
        ...
        function opcoesSuco(){
            ...
            opcoesSuco.forEach(opcaoSuco => {
                if (opcaoSuco.checked){
                    suco_escolhido = opcaoSuco.value
                    de = "de"+" "
                }
            })
            return de + suco_escolhido
        }
        ...
        function opcoesRefri(){
            ...
            opcoesRefri.forEach(opcaoRefri => {
                if (opcaoRefri.checked){
                    refri_escolhido = opcaoRefri.value  
                }
            })
            return refri_escolhido
        }
        ...
        function opcoesCoquetel(){
            ...
            var coquetel_escolhido = ""
            var de = ""

            opcoesCoquetel.forEach(opcaoCoquetel => {
                if (opcaoCoquetel.checked){
                    coquetel_escolhido = opcaoCoquetel.value
                    de = "de"+" "
                }
            })
            return de + coquetel_escolhido
        }
        ...
        let link = `https://wa.me/5592991635554?text=*PRODUTO:* ${qtdTr1}${ nomeTr1} ${qtdTr2}${ nomeTr2} ${qtdTr3}${ nomeTr3} ${qtdTr4}${ nomeTr4} ${qtdAt1}${ nomeAt1} ${qtdAt2}${ nomeAt2} ${qtdAt3}${ nomeAt3}  ${qtdDc1}${ nomeDc1} ${opcoesMoussie()} ${qtdDc2}${ nomeDc2} ${opcoesSorvete()} ${qtdDc3}${ nomeDc3} ${opcoesEmpadao()} ${qtdCb1}${ nomeCb1} ${opcoesSuco()} ${qtdCb2}${opcoesRefri()} ${qtdCb3}${ nomeCb3} ${opcoesCoquetel()} | *TOTAL:* ${ precoBurger} | *LOCALIZAÇÃO:* ${bair}, Rua ${ru}, casa ${cas} | *Método de Pagamento:* ${opcoesPagamento()} ${dinhei()}${simbolo_dinheiro_pagamento()} ${troco()} | *OBS:* ${ obs}`
        enviarZap.href = link
        enviarZap.setAttribute('target','_black')
